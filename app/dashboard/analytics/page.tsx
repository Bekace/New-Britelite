...
import { BarChart3, TrendingUp, Users, Monitor } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Monitor your digital signage performance</p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Your screens performance over the last 30 days</CardDescription>
        </CardHeader>
        <CardContent>
